    ...
    return BlocConsumer<LoginCubit,LoginState>(
      ...
      builder: (context, state) {
        return  Column(
          ...
          children: [
            CustomTextFormField(onchange: (value){}, text: "email", prefixIcon: Icons.person),
            SizedBox(
              height: MediaQuery
                  .of(context)
                  .size
            ...
            Align(alignment: Alignment.centerRight,child: Text("Forgot password ?",style:Styles.Montserratgrey16w300.copyWith(
                fontSize: 12.sp,
                color: AppColor.main
            ),)),
            SizedBox(
